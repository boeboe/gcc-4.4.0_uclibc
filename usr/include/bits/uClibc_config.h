...
#define __KERNEL_HEADERS__ "/build/dev/nitingarg/buildroot/toolchain_build_arm/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/build/dev/nitingarg/buildroot/build_arm/staging_dir/usr/bin/arm-linux-uclibcgnueabi-"
