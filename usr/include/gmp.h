...
#define __GMP_CC "/build/dev/nitingarg/buildroot/build_arm/staging_dir/usr/bin/arm-linux-uclibcgnueabi-gcc -Os -pipe -Os  -I/build/dev/nitingarg/buildroot/build_arm/staging_dir/usr/include -I/build/dev/nitingarg/buildroot/build_arm/staging_dir/include --sysroot=/build/dev/nitingarg/buildroot/build_arm/staging_dir/ -isysroot /build/dev/nitingarg/buildroot/build_arm/staging_dir -mtune=cortex-a9 -march=armv7-a -mabi=aapcs-linux -mfpu=vfpv3-d16 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64"
